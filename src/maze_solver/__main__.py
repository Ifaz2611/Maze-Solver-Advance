"""Advanced CLI - Maze Solver Laboratory v1.0."""
...
def _build_algorithms(args):
    ...
    # when benchmark without explicit list, use default suite
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Maze Solver Laboratory v1.0 - benchmark BFS/DFS/Dijkstra/A*/Greedy/Bi-BFS | Web GUI | Image export",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  maze-solver mazes/standard/labyrinth.maze
  maze-solver mazes/weighted/terrain_demo.maze --benchmark --heatmap
  maze-solver mazes/standard/miniature.maze --algorithm astar --heuristic octile --animate
  maze-solver --generate 31x21 --weighted --benchmark --output mazes/procedural/my.maze
  ...
  maze-solver maze.maze --algorithm bfs --export-json result.json --export-image result.png
    ...
    parser.add_argument("--show-weights", action="store_true", help="Show terrain glyphs")
    ...
    parser.add_argument("--weighted", action="store_true", help="Add terrain costs when generating")
    ...
    # Web / GUI modes - no maze required
    if args.web:
